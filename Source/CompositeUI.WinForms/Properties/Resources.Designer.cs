...
namespace Microsoft.Practices.CompositeUI.WinForms.Properties {
    ...
    internal class Resources {
        ...
        /// <summary>
        ///   查找类似 There are no zones in the workspace to display smart parts. 的本地化字符串。
        /// </summary>
        ...
        /// <summary>
        ///   查找类似 There is no zone named {0} to display the smart part in. 的本地化字符串。
        /// </summary>
        ...
        /// <summary>
        ///   查找类似 Smart part is not a control. 的本地化字符串。
        /// </summary>
        ...
        /// <summary>
        ///   查找类似 Smart part has not been shown previously by the current manager. 的本地化字符串。
        /// </summary>
        ...
        /// <summary>
        ///   查找类似 Workspace supports smart parts of type {0}. 的本地化字符串。
        /// </summary>
